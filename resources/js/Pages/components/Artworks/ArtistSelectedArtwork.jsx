...
export default function ArtistSelectedArtwork({ art, username }) {
                    ...
                    <div className="col-start-2 col-end-8 container bg-gray-900 border border-gray-700 rounded-lg shadow-lg p-8 mt-10">
                        ...
                        <div className="grid grid-cols-6 gap-4">
                            ...
                            <div className="col-span-3">
                                ...
                                <label
                                    htmlFor="modal-2"
                                    className={JSON.stringify(styles.buttun.normal) + " w-full bg-red-500 "}
                                >
                                    Delete Artwork
                                </label>

                            </div>
                            <DeleteArtwork art={art} username={username} />
